...
class WeatherClient(object):
    ...
    def almanac(self, location):
        ...
        return_response["high"]["normal"] = \
            jsondata['almanac']['temp_high']['normal']['C']
        return_response["high"]["record"] = \
            jsondata['almanac']['temp_high']['record']['C']

        return_response["high"]["year"] = \
            jsondata['almanac']['temp_high']['recordyear']

        return_response["low"] = {}
        return_response["low"]["normal"] = \
            jsondata['almanac']['temp_low']['normal']['C']
        return_response["low"]["record"] = \
            jsondata['almanac']['temp_low']['record']['C']
        return_response["low"]["year"] = \
            jsondata['almanac']['temp_low']['recordyear']
